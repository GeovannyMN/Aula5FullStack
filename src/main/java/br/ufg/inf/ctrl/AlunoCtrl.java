...
public class AlunoCtrl {
	...
	public List<Aluno> buscaTodos() {
		...
		try {
			...
			System.out.println("Erro ao tentar buscar os alunos cadastrados.");
			System.out.println(e.getMessage());
		}
		return alunos;
	}
	...
	public Aluno buscaPorId(Integer id) {
		...
		try {
			...
			System.out.println("Erro ao tentar buscar aluno do ID: " + id + ".");
			System.out.println(e.getMessage());
		}
		return aluno;
	}
	...
	public Aluno alterar(Aluno aluno) {
		try {
			if (negocio.buscaPorId(aluno.getIdAluno()) == null) {
				throw new AlunoException("Erro ao consultar Aluno no BD");
			}else {
